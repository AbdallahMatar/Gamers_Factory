...
<body class="app">
    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            ...
            <a href="{{ route('admin.dashboard') }}" id="mobile-menu-toggler"> <i data-feather="bar-chart-2"
    ...
    <div class="flex">
        ...
        <nav class="side-nav">
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul class="">
                        <li>
                            <a href="{{ route('admins.index') }}" class="side-menu">
                                <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="side-menu__title"> Index </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admins.create') }}" class="side-menu">
                                <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                ...
                <li>
                    <a href="javascript:;" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="edit"></i> </div>
                        <div class="side-menu__title"> Authors <i data-feather="chevron-down"
                                class="side-menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
                ...
                <li>
                    <a href="javascript:;" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="edit"></i> </div>
                        <div class="side-menu__title"> Categories <i data-feather="chevron-down"
                                class="side-menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
        ...
        <div class="content">
            ...
            <div class="top-bar">
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class=""></a> <a href=""
                        class="breadcrumb--active"></a> </div>
                <!-- BEGIN: Account Menu -->
                <div class="intro-x dropdown w-8 h-8 relative">
                    <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in">
                        <img alt="Midone Tailwind HTML Admin Template"
                            src="{{ url('storage/images/admin/' . Auth()->user()->image) }}">
                    </div>
